...
public class GetByIdRecipeUseCaseTest
{
    ...
    public async Task Error_Recipe_Not_Found()
    {
        ...
        Func<Task> act = async () =>
        {
            await useCase.Execute(recipeId:1000);
        };
    ...
    private static GetRecipeByIdUseCase CreateUseCase(IngrEasy.Domain.Entities.User user, IngrEasy.Domain.Entities.Recipe recipe = null)
    {
